...
public class ClassroomActivityPage extends BasePage{
    ...
    public void exoToolbarClick(){this.exoToolbarClick.click();}
    public MobileElement exoToolbarCheck(){exoToolbarCheck.getText();
        return exoToolbarCheck; }

    public void actionTouchOutside() {this.actionTouchOutside.click();}

    public void backButtonPlayerSettings() {this.backButtonPlayerSettings.click();}
    public void speedButtonPlayerSettings() {this.speedButtonPlayerSettings.click();}
    public void audioButtonPlayerSettings() {this.audioButtonPlayerSettings.click();}
    public void textButtonPlayerSettings() {this.textButtonPlayerSettings.click();}
    public void qualityButtonPlayerSettings() {this.qualityButtonPlayerSettings.click();}

    public void speedButtonx05() {this.speedButtonx05.click();}
    public void speedButtonx075() {this.speedButtonx075.click();}
    public void speedButtonx1() {this.speedButtonx1.click();}
    public void speedButtonx125() {this.speedButtonx125.click();}
    public void speedButtonx15() {this.speedButtonx15.click();}
    public void speedButtonx2() {this.speedButtonx2.click();}

    public void audioButton1() {this.audioButton1.click();}
    public void audioButton2() {this.audioButton2.click();}

    public void firstSubtitle() {this.firstSubtitle.click();}
    public void secondSubtitle() {this.secondSubtitle.click();}
    public void spanishSubtitle() {this.spanishSubtitle.click();}
    public void subtitlesOff() {this.subtitlesOff.click();}

    public void quality144p() {this.quality144p.click();}
    public void quality240p() {this.quality240p.click();}
    public void quality360p() {this.quality360p.click();}
    public void quality480p() {this.quality480p.click();}
    public void quality720p() {this.quality720p.click();}
    public void quality1080p() {this.quality1080p.click();}
    public void qualityAuto() {this.qualityAuto.click();}

    public void exoRew() {this.exoRew.click();}
    public void exoFfwd() {this.exoFfwd.click();}
    public void playerControls() {this.playerControls.click();}
    public void exoPlayPause() {this.exoPlayPause.click();}
    public void exoFullscreen() {this.exoFullscreen.click();}
    public void exoFullscreenExit() {this.exoFullscreenExit.click();}
    public void moreOptions() {this.moreOptions.click();}
    public void downloadClass() {this.downloadClass.click();}
    public void downloadModule() {this.downloadModule.click();}
    public void deleteModule() {this.deleteModule.click();}
    public MobileElement iconDownloadedClass() {this.iconDownloadedClass.getText();
        return null;
    }
    public MobileElement moduleDownloaded() {this.moduleDownloaded.getText();
        return null;
    }
